...
for i=1:n;
  ...
  disp('luego de clog:');
  disp(clog(i));
  disp('antes de minclog, tar y nontar:');
  disp(tar_opt_llrs(1:10))
  disp(nontar_opt_llrs(1:10))
...
%  subplot(2,n,i);plot(plo,minPe,'k--',plo,Pe,'k',plo,refPe,'k-.',[-2.29,-2.29],[0,1],'k:');grid;
  subplot(2,n,i);plot((1/log(10))*plo,minPe,'k--',(1/log(10))*plo,Pe,'b',(1/log(10))*plo,refPe,'g:');grid;
  title(name);
  eer = max(eer,max(Pe));
end;
