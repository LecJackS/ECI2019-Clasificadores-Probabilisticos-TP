% function [targetLrs,nonTargetLrs]=calibracion_zcal_curso(scoresTargetTrain,scoresNonTargetTrain,scoresTargetTest,scoresNonTargetTest)
% function [targetLrs,nonTargetLrs]=calibracion_zcal_curso(scoresTargetTrain,scoresNonTargetTrain,scoresTargetTest,scoresNonTargetTest,prior)
%
% Calibrates using s-cal.
%
% -- INPUT --
...
targetLrs=exp(calibration_zcal(log(scoresTargetTrain),log(scoresNonTargetTrain),log(scoresTargetTest)));
nonTargetLrs=exp(calibration_zcal(log(scoresTargetTrain),log(scoresNonTargetTrain),log(scoresNonTargetTest)));
...
xlabel('LR de Salida','FontSize',16);
